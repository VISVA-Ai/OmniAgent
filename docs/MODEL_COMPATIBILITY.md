...
The `openai_compat.rs` provider translates OmniAgent's internal message format to OpenAI-compatible chat completion requests. Different models have varying requirements for:
