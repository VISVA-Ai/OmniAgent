//! Core runtime primitives for the `omni` CLI and supporting crates.
//!
...
pub use stale_base::{
    check_base_commit, format_stale_base_warning, read_omni_base_file, resolve_expected_base,
